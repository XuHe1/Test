...
//            System.out.println(str1 == intern); // false  堆  常量池
//            System.out.println(str == str1);    // false  常量池 堆
//
//            System.out.println("**********************************************");
...
//            String intern = str1.intern(); // intern 指向常量池，常量池保存了 str1 指向同一块堆内存！！！
//            String str = "计算机软件"; // 放在 str1 上面一行，true false false
//            System.out.println("**********************************************");
//            System.out.println(str == intern); // false  常量池  堆
//            System.out.println(str1 == intern); // true  堆   堆
//            System.out.println(str == str1);    // false 常量池 堆
//
//            System.out.println("**********************************************");
            ...
            String str1 = new String("计算机") + new String("软件"); // 堆地址
            str1.intern(); // intern 指向常量池，常量池保存了 str1 指向同一块堆内存！！！
            String str = "计算机软件"; // 放在 str1 上面一行，true false false
            System.out.println(str == str1);    // false 常量池 堆  todo: 中英文不一样？？
            System.out.println("**********************************************");
//            System.out.println(str == intern); // false  常量池  堆
//            System.out.println(str1 == intern); // true  堆   堆
            ...
            str2.intern();				//（2）
            String str3 = "str01";		//（3）   堆内存地址！！！
            System.out.println(str2==str3); // true   todo: 中英文不一样？？
